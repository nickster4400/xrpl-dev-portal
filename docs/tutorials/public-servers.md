...
| QuickNode | |** XRPL Mainnet** | `https://www.quicknode.com/chains/xrpl` | QuickNode provides hosted XRPL RPC Mainnetnodes under their free and paid plans, granting flexible and reliable access to the network.
...
| QuickNode | | XRPL Testnet | `https://www.quicknode.com/chains/xrpl` | QuickNode provides hosted XRPL RPC testnet nodes under their free and paid plans, granting flexible and reliable access to the network.
